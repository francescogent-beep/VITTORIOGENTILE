  ...
  return (
    <div className="pb-20 lg:pb-40">
      ...
      <section className="relative min-h-[85vh] lg:min-h-screen flex items-center overflow-hidden bg-slate-950">
        <div className="absolute right-0 top-0 bottom-0 w-full lg:w-[45%] z-0">
          <img 
          ...
          <div className="max-w-4xl space-y-10 lg:space-y-12">
            <div className="space-y-6">
              <div className="flex items-center gap-4">
                ...
                <span className="text-[11px] font-black tracking-[0.5em] uppercase text-amber-500">
                  OPERATIONAL PRECISION
                </span>
              </div>
              
              <h1 className="text-6xl md:text-8xl lg:text-[10rem] font-black tracking-tighter leading-[0.85] text-white uppercase flex flex-col">
                <span>VITTORIO</span>
                <span className="text-slate-500 italic">GENTILE.</span>
              </h1>
              
              <div className="text-[10px] md:text-[13px] font-black tracking-[0.3em] md:tracking-[0.4em] text-amber-500 uppercase">
                {t(TAGLINE)}
              </div>
            </div>

            <div className="border-l-2 border-amber-500 pl-8">
              <p className="text-lg lg:text-2xl text-white font-medium leading-relaxed italic max-w-2xl">
                {t({
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
          ...
          <div className="p-8 lg:p-12 glass-effect rounded-[40px] lg:rounded-[50px] border border-white/5 hover:border-amber-500/20 transition-all group flex flex-col justify-between shadow-2xl bg-gradient-to-br from-white/[0.02] to-transparent">
            ...
            <div className="pt-8 lg:pt-10 border-t border-white/5">
              <Link to="/services/category/business" className="text-[10px] font-black uppercase tracking-widest text-slate-400 hover:text-amber-500 transition-colors flex items-center gap-3 group/link">
          ...
          <div className="p-8 lg:p-12 glass-effect rounded-[40px] lg:rounded-[50px] border border-white/5 hover:border-amber-500/20 transition-all group flex flex-col justify-between shadow-2xl bg-gradient-to-br from-white/[0.02] to-transparent">
            ...
            <div className="pt-8 lg:pt-10 border-t border-white/5">
              <Link to="/services/category/education" className="text-[10px] font-black uppercase tracking-widest text-slate-400 hover:text-amber-500 transition-colors flex items-center gap-3 group/link">
          ...
          <div className="p-8 lg:p-12 glass-effect rounded-[40px] lg:rounded-[50px] border border-white/5 hover:border-amber-500/20 transition-all group flex flex-col justify-between shadow-2xl bg-gradient-to-br from-white/[0.02] to-transparent">
            ...
            <div className="pt-8 lg:pt-10 border-t border-white/5">
              <Link to="/services/category/private" className="text-[10px] font-black uppercase tracking-widest text-slate-400 hover:text-amber-500 transition-colors flex items-center gap-3 group/link">
