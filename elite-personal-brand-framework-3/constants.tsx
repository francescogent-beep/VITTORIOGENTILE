...
export const SERVICES: Service[] = [
  ...
  // --- INDIVIDUALS (B2C) ---
  {
    ...
    faqs: [
      { question: { it: 'In quali città è disponibile il servizio?', en: 'In which cities is the service available?' }, answer: { it: 'Operiamo regolarmente a Roma e Londra, mas siamo disponibili per trasferte internazionali su richiesta.', en: 'We regularly operate in Rome and London, but we are available for international travel upon request.' } },
